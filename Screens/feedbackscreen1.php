...
<body>
	<div class="mt-3 mb-3 mr-3 ml-3">
		...
		<textarea name="feedback1" class="form-control" id="feedback1" rows="3" onkeyup="countChar1(this)" placeholder="Enter feedback here"></textarea>
		...
		<textarea name="feedback2" id="feedback2" class="form-control" rows="3" onkeyup="countChar2(this)" placeholder="Enter feedback here"></textarea>
		<div class="chcount"><small><span id="charCount2">800</span>/800 characters left</small></div>


		<button type="button" class="btn btn-default" onclick="window.location.href='before_training2.php'">Next</button>
