...
<body>
	...
	<form action="" method="post">
		...
		<div id = "subselection">
			<?php
			session_start();
			$scr9_subselect5 = $_SESSION['scr9_5'];
			// Displays the images
			...
			for ($i=0; $i<count($files); $i++)
			{
				...
				// if $filename is contained in $scr9_subselect5, then display the picture
				if (in_array($filename, $scr9_subselect5)) {
	...
	<p>
		<button type="button" onclick="window.location.href='http://ec2-18-221-159-134.us-east-2.compute.amazonaws.com/Screens/screen10.html'">Next</button>
	</p>
...
{ //to run PHP script on submit
	...
	$_SESSION['scr9_1'] = $scr9_subselect1;
