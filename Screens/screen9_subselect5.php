...
<!-- Takes images from subset2/select20 folder and puts them into subset2/select5 -->
...
<body>
	...
	<div id="subselection">
		<?php 
 		// Displays the images
		$files = glob("subset2/select20/*.jpg");
	...
	<p>
		<button type="button" onclick="window.location.href='http://ec2-18-221-159-134.us-east-2.compute.amazonaws.com/Screens/screen9_subselect1.php'">Next</button>
	</p>
