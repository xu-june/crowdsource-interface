<?php
    ...
    $_SESSION['phase'] = 'test2';
    // Gets array of objects and counts
    $objects = $_SESSION['objects_ts2'];
    ...
    function randomize() {
        ...
        if ($_SESSION['objects_ts2'][$obj1] < 5 || $_SESSION['objects_ts2'][$obj2] < 5 || $_SESSION['objects_ts2'][$obj3] < 5) {
    ...
    <script type="text/javascript">
        ...
        function captureImage() {
            ...
            $.ajax({
              ...
              data: { 
                 imgBase64: img.src,
                 filename: '<?php echo $_SESSION['pid']."_tmpObj_test2"?>'
              },
