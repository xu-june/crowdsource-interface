...
<?php
    ...
    savePageLog($_SESSION['pid'], "train1_subset20");
	...
	$obj_index = $_SESSION['train1_order'][$_SESSION['step']];
	...
	if ($_SESSION['step'] == 0) {
		...
		$sql = "UPDATE Objects set `subset1_".$obj_index."_1`='".str_replace(".png", "", implode(":", $tr1_subselect1))."'"
