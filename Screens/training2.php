    ...
    <script type="text/javascript">
        ...
        function captureImage() {
            ...
            $.ajax({
              ...
              data: { 
                 imgBase64: img.src,
                 filename: '<?php echo $_SESSION['pid']."_tmpObj_train2"?>'
              },
...
<body>
    <div class="mt-3 mb-3 mr-3 ml-3">
        ...
        <button type="button" id="nextbtn" class="btn btn-default" onclick="window.location.href='training2_subset20.php'" style="display: none;">Next</button>
