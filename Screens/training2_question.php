<?php
    ...
    */
    ...
    $sql = "INSERT INTO action_logs "
            ...
            .$_SESSION['pid'].",".$_SESSION['trial'].", 'training2_started', '".$time."', '".$date."');";
    execSQL($sql);
...
<h4>Questions </h4><br>        
The training process takes about 1 minute. Please answer the question below while you are waiting.
