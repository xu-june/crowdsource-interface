<html lang="en">
  <head>
    ...
    <title>Let's test our system!</title>
  </head>
  <body>
    <script>
    ...
    <div class="mt-3 mb-3 mr-3 ml-3">
        <div class="progress mb-3">
          <div class="progress-bar" role="progressbar" style="width: 80%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">8 / 10</div>
        </div>
        
        <div>
            <h2>Let's test the object recognizer! </h2>
        </div>
